...
public class ConstData {
     public static class Data{
         ...
         public static final int GamePanel_WIDTH = FRAME_WIDTH;
         public static final int GamePanel_HEIGHT = FRAME_WIDTH;

         public static final int upper_gap = FRAME_HEIGHT - GamePanel_WIDTH;
